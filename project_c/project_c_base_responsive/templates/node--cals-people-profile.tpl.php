 ...
 * @ingroup themeable
 *
 * TODO: Render the page title with the 'profile__name' class, if possible.
 */
  ...
  <div class="people-profile__main">
    <div class="people-profile__header">
      ...
      <div class="people-profile__basics">
        <h2 class="people-profile__work-title"><?php print $people_conditional_title; ?></h2>
        <div class="people-profile__address"><?php print render($content['field_people_address']); ?></div>
        <div class="people-profile_phone"><?php print render($content['field_people_phone']); ?></div>
