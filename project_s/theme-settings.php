 ...
 */
function project_s_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['project_s_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('project_s sample setting'),
  '#default_value' => theme_get_setting('project_s_example'),
